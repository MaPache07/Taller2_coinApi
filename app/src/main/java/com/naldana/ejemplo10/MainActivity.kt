...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    var twoPane =  false
    val coinLink:  String = "https://international-coins.herokuapp.com/api/coin/"
    ...
    inner class FetchCoinTask : AsyncTask<String,Void,String>(){
        override fun doInBackground(vararg params: String?): String? {
            var coinApi: URL = NetworkUtil().buildUrl(coinLink)
            var coinInfo: String = NetworkUtil().getResponseFromHttpUrl(coinApi)
            return null
        }
    }
